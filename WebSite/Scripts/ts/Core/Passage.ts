module Told.GreekBible.Data {
    ...
    export class BookInfo {
        ...
        static getBookNames() {
            return this.booksWithAbbreviations.map(b=> b.book);
        }

        static getChapterCount(bookNumber: number) {
        ...
        static getBookNumber(bookName: string) {
            return this.booksWithAbbreviations.filter(b=> b.book == bookName)[0].bookNumber;
        }

        static booksWithAbbreviations =
        [
