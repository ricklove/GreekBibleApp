    ...
    (function (GreekBible) {
        (function (Data) {
            var Parser = (function () {
                ...
                Parser.parsePassage = function (passageText) {
                    ...
                    var entries = lineData.map(function (l) {
                        return Parser.parseEntry(l);
                    });

                    var passage = { entries: entries };

                    return passage;
                };

                Parser.parseEntry = function (entryLine) {
                    var getPassageRef = function (bookChapterVerseCode) {
                    ...
                    var getMorphPerson = function (code) {
                        return code == "" ? null : code == "1" ? "1st" : code == "2" ? "2nd" : code == "3" ? "3rd" : code == "-" ? null : "PERSON?:" + code;
                    };

                    var getMorphTense = function (code) {
                        return code == "" ? null : code == "A" ? "Aorist" : code == "P" ? "Present" : code == "F" ? "Future" : code == "X" ? "Perfect" : code == "I" ? "Imperfect" : code == "-" ? null : "TENSE?:" + code;
                    };

                    var getMorphVoice = function (code) {
                        return code == "" ? null : code == "A" ? "Active" : code == "P" ? "Passive" : code == "M" ? "Middle" : code == "-" ? null : "VOICE?:" + code;
                    };

                    var getMorphMood = function (code) {
                        return code == "" ? null : code == "N" ? "Infinitive" : code == "S" ? "Subjunctive" : code == "P" ? "Participle" : code == "I" ? "Indicative" : code == "D" ? "Imperative" : code == "-" ? null : "MOOD?:" + code;
                    };

                    var getMorphCase = function (code) {
                        return code == "" ? null : code == "N" ? "Nominative" : code == "G" ? "Genitive" : code == "D" ? "Dative" : code == "A" ? "Accusative" : code == "V" ? "Vocative" : code == "-" ? null : "CASE?:" + code;
                    };

                    var getMorphNumber = function (code) {
                        return code == "" ? null : code == "S" ? "Singular" : code == "P" ? "Plural" : code == "-" ? null : "NUMBER?:" + code;
                    };

                    var getMorphGender = function (code) {
                        return code == "" ? null : code == "M" ? "Masculine" : code == "F" ? "Feminine" : code == "N" ? "Neuter" : code == "-" ? null : "GENDER?:" + code;
                    };

                    var getMorphDegree = function (code) {
                        return code == "" ? null : code == "C" ? "Comparative" : code == "S" ? "Superlative" : code == "-" ? null : "DEGREE?:" + code;
                    };
                    ...
                    var getPartOfSpeechMainPart = function (code) {
                        return code == "" ? null : code == "N" ? "Noun" : code == "V" ? "Verb" : code == "A" ? "Adjective" : code == "D" ? "Adverb" : code == "C" ? "Conjunction" : code == "P" ? "Preposition" : code == "R" ? "Pronoun" : code == "I" ? "Interjection" : code == "X" ? "Particle" : code == "-" ? null : "PartOfSpeech-Main?:" + code;
                    };

                    var getPartOfSpeechSecondPart = function (code) {
                        return code == "" ? null : code == "A" ? "Article" : code == "I" ? "Indefinite" : code == "P" ? "Possesive" : code == "D" ? "Demonstrative" : code == "R" ? "Relative" : code == "-" ? null : "PartOfSpeech-Second?:" + code;
                    };
