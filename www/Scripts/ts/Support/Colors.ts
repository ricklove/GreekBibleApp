module Told.GreekBible.Colors {

    var createGetUniqueColorInner = function (saturation?: number, brightness?: number) {
        ...
        var getColorId = function (text: string) {
            colorIds[text] = colorIds[text] || nextId++;

            return colorIds[text];
        }

        var getColorByText = function (text: string) {
    ...
    export var createGetUniqueColor = createGetUniqueColorInner;

    var getUniqueColor = function (saturation: number, brightness: number, id: number) {
